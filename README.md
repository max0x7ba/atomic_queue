# atomic_queue
multiple-producer-multiple-consumer C++14 *lock-free* queues based on `std::atomic<>`. Based on ideas from [A Wait-free Queue as Fast as Fetch-and-Add whitepaper](http://chaoran.me/assets/pdf/wfq-ppopp16.pdf).
