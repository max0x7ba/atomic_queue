...
chrt_fifo := $(chrt -f 50 echo -n 'chrt' || echo -n 'sudo -E chrt') -f 50
uname_m := $(uname -m)
...
# cd ~/src/atomic_queue; source ./scripts/util.sh; format_benchmark results/adea692.ryzen_5825u.*.33.txt
# cd ~/src/atomic_queue; source ./scripts/util.sh; format_benchmark results/632bae1.ryzen_5950x.*.33.txt
