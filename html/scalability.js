...
$(function() {
    ...
    plot('scalability-7700k-5GHz', results_to_series(results_7700k), "Intel 7700k 5Ghz");
    plot('scalability-xeon-gold-6132', results_to_series(results_xeon_gold_6132), "Intel Xeon Gold 6132");
});
